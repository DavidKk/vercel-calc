...
/**
 * Props for the FuelInputSection component
 */
export interface FuelInputSectionProps {
...
/**
 * FuelInputSection component provides input fields for province selection, fuel type selection,
 * recharge amount, and gift amount for fuel discount calculation
 * @param props - FuelInputSection component props
 * @returns React component for inputting fuel discount data
 */
export function FuelInputSection({
  fuelTypes,
  provinces,
  selectedFuel,
  selectedProvince,
